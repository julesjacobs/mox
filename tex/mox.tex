...
We write simply $\RefCell{e}$ when allocating a cell; the resulting handle adopts the most precise capability $r_0 = (\mode{unique}, \mode{local}, \mode{uncontended})$, with weaker modes obtained by subtyping its type.
