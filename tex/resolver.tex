...
Let $\mathcal{O}$ be a finite set of sorts.
For each $A\in\mathcal{O}$, fix a finite carrier $V_A$.
...
For finite carriers $\{V_A\}_{A\in\mathcal{O}}$ and a typed family $\RelSet$, the
