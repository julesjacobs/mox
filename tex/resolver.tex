...
We can picture the relations before and after elimination of a variable as follows:
...
\begin{tikzpicture}[>=Latex]
  \begin{scope}[xshift=-3.5cm]
    ...
    \node[font=\small] at (0,-3) {Before elimination};
  \end{scope}
  ...
  \begin{scope}[xshift=4.2cm]
    ...
    \node[font=\small] at (0,-3) {After elimination};
  \end{scope}
\end{tikzpicture}
...
If there were existing relations between the $y_i$ then we intersect them with these.
