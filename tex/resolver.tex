...
\begin{itemize}
  \item Sorts O
  \item Relation families R_{A,B}, A,B in O.
  \item Closure under *typed* operations: composition, intersection, converse, diagonal restriction.
  \item Formulate Helly-2 slice property for many-sorted case (per sort).
\end{itemize}
